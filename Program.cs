...
namespace Project1
{
    internal class Program
    {
        ...
        List<string> symbolfruit = new List<string>() { "n", "g", "o", "c"}; //doi dang ki tu
        ...
        void randomQua()
        {
            if (score < 2) typefruit = 1;
            else typefruit = rand.Next(1, 4);
        ...
        void Update()
        {
            while (!gameOver)
            {
                ...
                Thread.Sleep(tocdo());   //Phat trien: tuy chinh toc do
            }
            if (gameOver) Lose();
        }
        ...
        int tocdo()
        {
            ...
            if (20 < score &&score < 50) return 50;
        ...
        void Render()
        {
            ...
            Console.WriteLine("Diem cua ban: {0} ", score);
            Console.ForegroundColor= ConsoleColor.White;
            Console.WriteLine("diem cao nhat : {0}", high_score);
        }
        //Xy ly game thua
        void Lose()
        {
            if (high_score < score)  //cap nhat diem cao nhat sau khi thua
            {
                high_score = score;
            }
        ...
        void xoabang()
        {
            Console.WriteLine("- nhan phim X de xoa bảng ");
